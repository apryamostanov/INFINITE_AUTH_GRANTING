...
class G02_GrantTypeGenerator {
    ...
    void generate_data(I_grant_type_repository p_grant_repository) {
        ...
        l_entity_set.add(new GrantType(restResourceName: "ListStatementDate", method: "GET", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber|AccountNumber}"]"""))
        ...
        l_entity_set.add(new GrantType(restResourceName: "CardSearchEnhanced", method: "GET", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber|AccountNumber}"]"""))
        l_entity_set.add(new GrantType(restResourceName: "W2WTransferInitiateEnhanced", method: "POST", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber|AccountNumber}"]"""))
        ...
        l_entity_set.add(new GrantType(restResourceName: "GetTransactionDetail", method: "GET", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber|AccountNumber}"]"""))
        ...
        l_entity_set.add(new GrantType(restResourceName: "StatementsInformation", method: "GET", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber|AccountNumber}"]"""))
        l_entity_set.add(new GrantType(restResourceName: "UpdateWalletPriority", method: "POST", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber|AccountNumber}"]"""))
        ...
        l_entity_set.add(new GrantType(restResourceName: "VirtualCardUpdate", method: "POST", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber}"]"""))
        ...
        l_entity_set.add(new GrantType(restResourceName: "ForgotPIN", method: "POST", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber}"]"""))
        l_entity_set.add(new GrantType(restResourceName: "ForgotPINValidationParameters", method: "GET", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber}"]"""))
        l_entity_set.add(new GrantType(restResourceName: "GenerateOTP", method: "POST", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber}"]"""))
        l_entity_set.add(new GrantType(restResourceName: "SendOTPSMS", method: "POST", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber}"]"""))
        ...
        l_entity_set.add(new GrantType(restResourceName: "UpdateProfileWithPhone", method: "POST", keyFieldSetJson: """["{parameter: CardNumber|ProxyNumber}", ["MobilePhoneCountryCode", "MobileNumber"]]"""))
