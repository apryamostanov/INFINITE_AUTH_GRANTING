...
class G05_IdentityTypeGenerator {
    ...
    void generate_data(I_identity_type_repository p_identity_repository, I_authentication_type_repository p_authentication_repository) {
        ...
        l_entity_set.add(new IdentityType(identityName: "Owner of AccessorType Data", authenticationSet: [p_authentication_repository.findByAuthenticationName("Accessor_data").first()]))
