...
class T_auth_grant_base_4_const extends T_common_base_3_utils {
    ...
    static final String GC_RESOURCE_ABSOLUTE_URL = "resourceAbsoluteUrl"
    ...
    static final Boolean GC_IS_REFERENCED_YES = true
    static final Boolean GC_IS_REFERENCED_NO = false
