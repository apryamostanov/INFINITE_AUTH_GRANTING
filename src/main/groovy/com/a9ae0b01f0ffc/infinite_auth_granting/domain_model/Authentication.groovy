...
class Authentication extends T_hal_resource {
    ...
    void common_authentication_validation(Authentication i_conf_authentication, Map<String, String> o_key_field_map, Map<String, String> o_functional_field_map, T_auth_grant_base_5_context i_context) {
