...
class G02_GrantTypeGenerator {
    ...
    void generate_data(I_grant_type_repository p_grant_repository) {
        ...
        l_entity_set.add(new GrantType(restResourceName: "SendOTPSMS", method: "POST", keyFieldRuleName: "", maxUsageCountWithinScope: 3))
        ...
        l_entity_set.add(new GrantType(restResourceName: "ValidateOTPSMS", method: "GET", keyFieldRuleName: "", maxUsageCountWithinScope: 9))
        ...
        l_entity_set.add(new GrantType(restResourceName: "ValidateIDDocument", method: "POST", keyFieldRuleName: "", maxUsageCountWithinScope: 5))
        ...
        l_entity_set.add(new GrantType(restResourceName: "UpdateEEPaymentResponse", method: "POST", keyFieldRuleName: "", maxUsageCountWithinScope: 1))
