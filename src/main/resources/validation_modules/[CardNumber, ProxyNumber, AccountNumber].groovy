...
if (i_method == "POST") {
    ...
    try {
        ...
        l_card_number = l_gpath_result.depthFirst().findAll({ l_element -> l_element.name() == "CardNumber" }).getAt(GC_FIRST_INDEX)
        l_proxy_number = l_gpath_result.depthFirst().findAll({ l_element -> l_element.name() == "ProxyNumber" }).getAt(GC_FIRST_INDEX)
        l_account_number = l_gpath_result.depthFirst().findAll({ l_element -> l_element.name() == "AccountNumber" }).getAt(GC_FIRST_INDEX)
...
if (is_not_null(l_proxy_number)) {
    System.out.println(l_proxy_number)
    System.out.println(l_expected_proxy_number)
